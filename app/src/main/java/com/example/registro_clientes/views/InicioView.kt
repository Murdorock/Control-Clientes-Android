    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(text = "Control de Clientes", color = Color.White, fontWeight = FontWeight.Bold)
                },
            ...
            items(state.listaUsuarios) {
                Box(
                    ...
                    Column(
                        ...
                        Text(text = it.cedula)
                        Text(text = it.nombre)
                        Text(text = it.apellido)
                        Text(text = it.correo)
                        Text(text = it.telefono)
                        IconButton(
                            onClick = { navController.navigate("editar/${it.id}/${it.cedula}/${it.nombre}/${it.apellido}/${it.correo}/${it.telefono}") }
                        ) {
